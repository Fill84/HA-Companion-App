...
const translations = {
    en: {
        ...
        sensors: "Sensors",
        sensor_selection_help: "Choose which discovered readings to send to Home Assistant. Related readings are grouped.",
        sensor_group: "Group",
        sensor_diagnostics: "Diagnostics",
        diagnostic_current: "Current reading",
        diagnostic_last_value: "Last valid reading",
        diagnostic_source: "Last known measurement source",
        diagnostic_last_read: "Last valid local reading",
        diagnostic_ha_ack: "Last confirmed by Home Assistant",
        diagnostic_status: "Status",
        diagnostic_never: "Not yet recorded",
        diagnostic_unknown: "Unknown",
        diagnostic_not_reported: "Not reported",
        diagnostic_waiting: "Waiting for the normal update cycle",
        diagnostic_disabled: "Disabled in Settings",
        diagnostic_sync_pending: "Latest reading not yet confirmed by Home Assistant",
        diagnostic_unavailable: "Diagnostics are temporarily unavailable",
        diagnostic_reason_not_emitted: "The collector did not return this reading; hardware may be absent or the provider may not support it",
        diagnostic_reason_disabled: "This reading was not collected because it is disabled",
        diagnostic_reason_no_value: "The provider returned no valid value",
        diagnostic_reason_provider_error: "The temperature provider reported an error",
        diagnostic_reason_provider_unavailable: "The temperature provider could not be reached",
        diagnostic_reason_provider_timeout: "The temperature provider timed out",
        diagnostic_reason_incompatible_provider: "The temperature provider protocol is incompatible",
        diagnostic_reason_driver_unavailable: "The temperature driver is unavailable",
        diagnostic_reason_unsupported: "This hardware or platform has no supported temperature reading",
        diagnostic_reason_invalid_response: "The temperature provider returned an invalid reading",
        ...
        not_registered: "No registration saved",
        updates_at_interval: "Updates at interval",
        static_sensor: "Every 10 intervals",
        ...
        settings_saved_sync_pending: "Settings saved. Sensor changes are not yet confirmed in Home Assistant. Check the connection and device registration.",
    ...
    nl: {
        ...
        sensors: "Sensoren",
        sensor_selection_help: "Kies welke gevonden metingen naar Home Assistant gaan. Verwante metingen staan in een groep.",
        sensor_group: "Groep",
        sensor_diagnostics: "Diagnose",
        diagnostic_current: "Huidige meting",
        diagnostic_last_value: "Laatste geldige meting",
        diagnostic_source: "Laatst bekende meetbron",
        diagnostic_last_read: "Laatste geldige lokale meting",
        diagnostic_ha_ack: "Laatst bevestigd door Home Assistant",
        diagnostic_status: "Status",
        diagnostic_never: "Nog niet vastgelegd",
        diagnostic_unknown: "Onbekend",
        diagnostic_not_reported: "Niet gerapporteerd",
        diagnostic_waiting: "Wachten op de normale meetcyclus",
        diagnostic_disabled: "Uitgeschakeld in Instellingen",
        diagnostic_sync_pending: "Nieuwste meting nog niet bevestigd door Home Assistant",
        diagnostic_unavailable: "Diagnose tijdelijk niet beschikbaar",
        diagnostic_reason_not_emitted: "De collector leverde deze meting niet; hardware kan ontbreken of de provider ondersteunt haar niet",
        diagnostic_reason_disabled: "Deze meting is niet uitgevoerd omdat zij uitgeschakeld is",
        diagnostic_reason_no_value: "De provider leverde geen geldige waarde",
        diagnostic_reason_provider_error: "De temperatuurprovider meldde een fout",
        diagnostic_reason_provider_unavailable: "De temperatuurprovider is niet bereikbaar",
        diagnostic_reason_provider_timeout: "De temperatuurprovider reageerde niet op tijd",
        diagnostic_reason_incompatible_provider: "Het protocol van de temperatuurprovider is niet compatibel",
        diagnostic_reason_driver_unavailable: "De temperatuurdriver is niet beschikbaar",
        diagnostic_reason_unsupported: "Geen ondersteunde temperatuurmeting voor deze hardware of dit platform",
        diagnostic_reason_invalid_response: "De temperatuurprovider leverde een ongeldige meting",
        ...
        save: "Opslaan",
        cancel: "Annuleren",
        registered: "Registratie opgeslagen",
        not_registered: "Geen registratie opgeslagen",
        updates_at_interval: "Update bij interval",
        static_sensor: "Elke 10 intervallen",
        ...
        settings_saved_sync_pending: "Instellingen opgeslagen. Sensorwijzigingen zijn nog niet bevestigd in Home Assistant. Controleer de verbinding en apparaatregistratie.",
