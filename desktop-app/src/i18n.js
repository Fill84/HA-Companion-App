...
const translations = {
    en: {
        ...
        settings_saved_sync_pending: "Settings saved. Sensor changes will appear in Home Assistant when the connection recovers.",
    ...
    nl: {
        ...
        settings_saved_sync_pending: "Instellingen opgeslagen. Sensorwijzigingen verschijnen in Home Assistant zodra de verbinding is hersteld.",
