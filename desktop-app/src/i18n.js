...
const translations = {
    en: {
        ...
        sensors: "Sensors",
        sensor_selection_help: "Choose a group, then choose which discovered readings to send to Home Assistant.",
        sensor_group: "Group",
    ...
    nl: {
        ...
        sensors: "Sensoren",
        sensor_selection_help: "Kies een groep en daarna welke gevonden metingen naar Home Assistant gaan.",
        sensor_group: "Groep",
