...
const translations = {
    en: {
        ...
        temperature_provider_help: "Requires the official PawnIO driver (2.2 or newer), installed separately. The .NET helper is included with the app. Disabled by default. Without a supported reading, CPU temperature is unknown. The app does not install a driver.",
        sensors: "Sensors",
    ...
    nl: {
        ...
        temperature_provider_help: "Vereist de officiële PawnIO-driver (2.2 of nieuwer), afzonderlijk geïnstalleerd. De .NET-helper wordt met de app meegeleverd. Standaard uitgeschakeld. Zonder ondersteunde meting is de CPU-temperatuur onbekend. De app installeert geen driver.",
        sensors: "Sensoren",
