...
const translations = {
    en: {
        ...
        temperature_provider_help: "The app installer can add the bundled, signed PawnIO driver for supported Intel CPUs. Enable this after choosing driver installation. No separate sensor app or .NET runtime is needed. If unavailable, CPU temperature remains unknown.",
        sensors: "Sensors",
    ...
    nl: {
        ...
        temperature_provider_help: "De app-installer kan de meegeleverde, ondertekende PawnIO-driver voor ondersteunde Intel-CPU's installeren. Schakel dit in na die installatiekeuze. Er is geen aparte sensorapp of .NET-runtime nodig. Zonder meting blijft de CPU-temperatuur onbekend.",
        sensors: "Sensoren",
